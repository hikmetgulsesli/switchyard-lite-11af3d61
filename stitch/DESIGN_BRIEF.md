...
- Switchyard Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called Switchyard Lite. It should be a full-viewport rail-switching arcade puzzle where the player routes moving trains through track junctions, avoids collisions, scores completed routes, and can open an in-game settings screen for speed, difficulty, audio, pause/resume, and res…
...
- Gameplay - Switchyard Lite
- Game Settings - Switchyard Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - Switchyard Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - Switchyard Lite
